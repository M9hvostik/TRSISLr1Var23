 ...
 * @author 0
 */
@WebServlet(name = "ChangeProductServlet", urlPatterns = {"/changeProduct"})
public class ChangeProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ChangeProductServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ChangeProductServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            fridgeObj.updateProduct(id, name, productionDate, expirationDate);
        } catch (ParseException ex) {
            Logger.getLogger(ChangeProductServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
